...
import EnhancedToothChart from '../../components/dental/EnhancedToothChart';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-md mb-6">
        ...
        <div className="p-4">
          {activeTab === 'chart' && (
            <EnhancedToothChart patientId={patientId} readOnly={!canEditDental} />
          )}
          {activeTab === 'treatments' && (
...
export default EnhancedDentalEHR;

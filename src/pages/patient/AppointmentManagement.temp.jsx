...
import { FaCalendarAlt, FaList, FaPlus, FaHistory, FaClipboardCheck, FaFileInvoice, FaSearch } from 'react-icons/fa';
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (!clinicId) {
        ...
        if (!clinicId) {
          // Try to get from user object in localStorage as last resort
          try {
